<template>
  <div>
    <phonealbum ref="phonealbum" :imgsArr="imgsArr" backgroundColor="skyblue" />
    <button @click="show">测试</button>
  </div>
</template>

<script>
import phonealbum from "../../src";
...
export default {
  ...
  data() {
    return {
      imgsArr: [ 
        {
          src: "https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fpic1.zhimg.com%2Fv2-956295fc660aee9127c9ecb4b9b32090_r.jpg%3Fsource%3D1940ef5c&refer=http%3A%2F%2Fpic1.zhimg.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1638930030&t=2db2b30550cc51b759f87fd17160e041", 
        },
        {
  ...
  methods: {
    show: function () { 
      this.$refs.phonealbum.show({index:1});
    },
  },
};
</script>
